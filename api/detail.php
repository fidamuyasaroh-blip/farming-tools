<?php
// PERBAIKAN: Ganti $_SERVER['DOCUMENT_ROOT'] dengan __DIR__ (lebih stabil di Vercel)
...
<head>
    ...
    <title>Detail - <?= htmlspecialchars($nama) ?></title>
        ...
        <div class="card detail-card shadow-lg">
            <div class="row g-0">
                <div class="col-md-6 img-container p-4">
                    <!-- PERBAIKAN: Gambar diambil dari path yang benar di Vercel -->
                    <img src="/img/<?= htmlspecialchars($gambar) ?>" 
                         class="img-fluid" 
                         alt="<?= htmlspecialchars($nama) ?>"
                         onerror="this.onerror=null;this.src='https://placehold.co/300x300?text=Gambar+Tidak+Ada';">
                </div>

                <div class="col-md-6 p-4 p-lg-5 bg-white">
                    <h1 class="fw-bold mb-3"><?= htmlspecialchars($nama) ?></h1>
