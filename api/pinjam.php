<?php
// PERBAIKAN: Ganti $_SERVER['DOCUMENT_ROOT'] dengan __DIR__
...
$id_alat = isset($_GET['id']) ? mysqli_real_escape_string($koneksi, $_GET['id']) : 0;
...
<head>
    <meta charset="UTF-8">
    <title>Konfirmasi Sewa - <?= htmlspecialchars($data['nama_alat']) ?></title>
